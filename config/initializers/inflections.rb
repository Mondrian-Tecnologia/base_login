...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular 'historico_email', 'historico_emails'

  # Propio do Sistema
  inflect.irregular 'dute_version',          'dute_versions'
  inflect.irregular 'cartorio_version',      'cartorio_versions'
  inflect.irregular 'dado_cartorario',       'dados_cartorarios'
  inflect.irregular 'arquivo_remessa',       'arquivos_remessas'
  inflect.irregular 'arquivo_pagamento',     'arquivos_pagamentos'
  inflect.irregular 'retorno_bradesco',      'retornos_bradescos'
  inflect.irregular 'item_repasse',          'itens_repasses'
  inflect.irregular 'bloqueio_excecao',      'bloqueios_excecoes'
  inflect.irregular 'pagamento_financeira',  'pagamentos_financeiras'
  inflect.irregular 'boleto_financeira',     'boletos_financeiras'
end
